...
-- inserting data into financial_resources table
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Aikido klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Atletski športski klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski aikido klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Atletski klub Alojzije Stepinac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Atletski klub Olympionik'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Atletski klub Start'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub atletskih veterana Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Automobilistički klub ZD tuning'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Badminton klub Iader'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Baseball klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Biciklistički klub Sv. Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Biciklistički klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Biciklistički klub Macaklin'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Biljar klub 11'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski klub Bili Brig'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski klub Brodarica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski klub Veteran'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski klub Crvene kuće'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boksački klub Diabolik'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boksački klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Jedriličarski klub Uskok'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Judo klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Jazine - Arbanasi'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Zadar š.d.d.'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kuglački klub Donat zaštita'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kuglački klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Nogometni klub Zadar š.d.d.'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Odbojkaški klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Planinarsko društvo Paklenica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Plivački klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ronilački klub "KPA"'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Stolnoteniski klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Streljački klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Šahovski klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športsko ribolovno društvo Zubatac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ordinacija Športske medicine'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Teniski klub Zadar 08'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga za šport i rekreaciju invalida Grada Zadra'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Veslački klub Jadran'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Javna ustanova za upravljanje športskim objektima - Zadarski šport d.o.o.'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ženski rukometni klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski plesni klub Samba'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Diklo'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ronilaćki klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Stolnoteniski klub Jadera'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Voštarnica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Nogometni Klub Arbanasi'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Karate klub Croatia'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Plivački klub Jadera'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Triatlon klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Taekwondo klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Pet bunara - veterani'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Rukometni klub Zadar 1954'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Karate klub Zvonimir'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Višnjik'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kuglački klub Donat Zadar - Žene'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub ritmičke gimnastike Sirena'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Automobilistički klub RTZ'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo Športske rekreacije Vitalnost'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub ABC'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športska škola košarke Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga za mali nogomet Zadarske županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Futsal'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Puntamika'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športsko rekreacijska udruga Sklek'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Streličarski klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ragbi klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Vaterpolski klub Zadar 1952'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Gimnastički klub Salto'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Šahovski klub Casper'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Silba'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Drakmar Sali'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Županijski savez školskog športa Zadarske županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Hrvatsko planinarsko društvo Mala Rava'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kuglački klub Liburnija'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Hrvački klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo Športske Rekreacije Dite zadarsko'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Odbojkaški klub Arbanasi'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub daljinskog plivanja Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kiteboarding udruga Adrenalin'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub jedrenja na dasci Fortunal'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo za športsku rekreaciju Relaks'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski klub za skokove u vodu Arno'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kickboxing klub Sv. Krševan'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boksački klub Sv. Krševan'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Varoš'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Sonik Puntamika'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kickboxing klub Sv. Zoilo'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Euforija'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo za športsku rekreaciju Hula-hop'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Košarkaški klub Zara'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boksački klub Dijagora'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski centar Višnjik d.o.o.'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ženski košarkaški klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Jedriličarski klub Sv. Krševan'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Karate  klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ju jitsu klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ju jitsu klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boksački klub Zlatna Rukavica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Body Building klub Hulk'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Taekwondo klub Plovanija'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Gimnastički klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Konjički klub Epona'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Streljački klub Lovac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub za skokove u vodu Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Rukometni klub Arbanasi'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Klub za športski ribolov Paprenica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski ribolovni klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Alpinistički klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Odbojkaški klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Hrvatski nogometni klub Dalmatinac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga slijepih Zadarske Županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski savez gluhih Zadarske Županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Odbojkaški klub invalida Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kuglački klub invalida Dišpet'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Plivački klub osoba s invaliditetom Sv. Nikola'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Stolnoteniski klub osoba s invaliditetom Sv. Krševan'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Streljački klub osoba s invaliditetom Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ribolovni klub osoba s invaliditetom Škartoc'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Športski savez osoba s invaliditetom Zadarske županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kendo klub "Ouka"'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Pikado Savez Zadarske župnije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga za "Down sindrom" Zadarske županije'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ronilački klub 2 dive'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Brodarica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Petrčane'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Osmijeh za-Dar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Novi Bokanjac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Kožino'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Dragovoljac'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Crvene kuće'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo Bokanjac Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Bili Brig'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Društvo športske rekreacije Loptica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga mladih Ista'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Zadarska plesna udruga Tornadele'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kyudo udruga Yumi - Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Ženski nogometni klub Donat'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Bili Brig'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Plovanija'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Voštarnica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Ploča'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Stanovi'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Sv. Ante'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Zapuntel'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Mala Rava'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Rukometni klub Zadar 2013'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Jedriličarski klub Punta Bajlo'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Plivački klub osoba s invaliditetom Frogo'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Hrvatsko planinarsko društvo Zavrata'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Udruga Hrvatskih vojnih invalida domovinskog rata - Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Aero klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Boćarski Športski klub Zadar'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='GRADSKI OGRANAK UDRUGE HRVATSKIH DRAGOVOLJACA DOMOVINSKOG RATA GRADA ZADRA'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Malonogometni klub Brodarica'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Kick-Boxing klub Fight Factory'));
insert into diskobolos.financial_resources(member_register_id) values ((select id from diskobolos.member_register where name='Planinarsko društvo Sveti Bernard'));
