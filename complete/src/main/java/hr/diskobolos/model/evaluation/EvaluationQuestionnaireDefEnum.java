...
public enum EvaluationQuestionnaireDefEnum {
    ...
    /**
     * Categorization of sports per sport club
     */
    CATEGORIZATION_ACCORDING_TO_NUMBER_OF_REGISTERED_CLUBS_IN_NATIONAL_FEDERATION(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_ON_NATIONAL_FEDERATION_LEVEL),
    CATEGORIZATION_BY_TYPE_OF_SPORT(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_ON_SPORT_TYPE_LEVEL),
    CATEGORIZATION_ACCORDING_TO_AGE_CATEGORIES(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_ACCORDING_TO_AGE),
    CATEGORIZATION_ACCORDING_TO_RANK_OF_COMPETITION_SYSTEM(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_ON_COMPETITION_SYSTEM_LEVEL),
    CATEGORIZATION_ACCORDING_TO_NUMBER_OF_TEAM_MEMBERS_COMPETING(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_BASED_ON_NUMBER_OF_TEAM_MEMBERS_COMPETING),
    CATEGORIZATION_ACCORDING_TO_MASS_IN_SPORTS_SCHOOLS(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_BASED_ON_MASS_IN_SPORTS_SCHOOLS),
    CATEGORIZATION_ACCORDING_TO_PROFESSIONAL_STAFF(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_BASED_ON_PROFESSIONAL_STAFF),
    CATEGORIZATION_ACCORDING_TO_TRADITION_OF_TOWN_ZADAR(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.CATEGORIZATION_BASED_ON_TRADITION_OF_TOWN_ZADAR),
    COFFICIENCY_OF_SPORTS_CATEGORY(QuestionInputType.RADIO, QuestionnaireType.CATEGORIZATION_OF_SPORTS_PER_SPORT_CLUB, QuestionGroup.SPORT_CATEGORY_COEFFICIENT);
